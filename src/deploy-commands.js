...
const commands = [
  ...
  new SlashCommandBuilder()
    ...
    .addIntegerOption(opt => opt.setName('amount').setDescription('CTK amount to redeem').setMinValue(1).setRequired(true))
    .addStringOption(opt => opt.setName('item').setDescription('What you want to redeem').setRequired(true)),
